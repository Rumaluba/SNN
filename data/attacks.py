...
def fgsm(model, images, labels, epsilon, criterion, encoder, num_steps, m=10):
...
def pgd(model, images, labels, epsilon, alpha, num_iter, criterion, encoder, num_steps, m=10):
